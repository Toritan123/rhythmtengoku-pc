...
| `RTPC_VOLUME=<pct>` | master volume, default 100 (the game's own level, -16.2 dBFS RMS). Higher values are soft-limited rather than clipped; 160 measures -12.8 dBFS. |
