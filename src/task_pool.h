...
extern s32 start_new_task(u16 memID, const struct TaskMethods *methods, void *inputs, TaskFinalFunc onFinish, uintptr_t onFinishArg);
...
extern void run_func_after_task(s32 poolID, TaskFinalFunc onFinish, intptr_t onFinishArg);
