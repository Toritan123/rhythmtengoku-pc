/* Generated by tools/bs2c.py from data/scenes/results/debug_scene.bs — do not edit. */
#include "global.h"
#include "src/main.h"
#include "src/audio.h"
...
extern const struct Beatscript script_scene_results_ver_debug[];
extern const struct SubScene sub_scene_results_ver_debug;
extern struct Scene scene_results_ver_debug;

const struct Beatscript script_scene_results_ver_debug[] = {
    { 0x03, 0, (const void *)(set_beatscript_tempo), (uintptr_t)(120) },
    { 0x03, 0, (const void *)(set_pause_beatscript_scene), (uintptr_t)(TRUE) },
    { 0x03, 0, (const void *)(results_render_skill_screen), (uintptr_t)(0) },
...
const struct SubScene sub_scene_results_ver_debug = {
    /* start  */ (void (*)())results_scene_start, 0,
    /* paused */ (void (*)())results_scene_paused, 0,
    /* update */ (void (*)())results_scene_update, 0,
    /* stop   */ (void (*)())results_scene_stop, 0,
    /* script */ script_scene_results_ver_debug,
};

struct Scene scene_results_ver_debug = {
    /* init   */ (void (*)())func_0801d86c, (void *)(&sub_scene_results_ver_debug),
